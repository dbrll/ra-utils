/*
* Reads the frequency/power values from a spectum and a reference file. 
* Then performs the reference division, RFI removal, slope correction, 
* conversion to radial velocity, and outputs the resulting values.
*
